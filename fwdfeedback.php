...
if (isset($_POST['submit'])) {
    ...
    $sql3 = "UPDATE feedback SET feedback_type = '$feedback_type', status ='$status' WHERE feedback_id = '$id'";
...
<body>
    ...
    <form name="login" method="post" action="" >
        ...
        <div class="radiob">
            <input type="radio" name="status" value="Under Review" checked> Under Review
