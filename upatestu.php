...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "UPDATE Student set student_id='$id' ,fname='$fname', username='$username', email='$email', contact_number='$contact_number', password='$hash' WHERE student_id='$id'";

    if (mysqli_query($conn, $sql1)) {
        header("Location: dispstud.php?message=success");
    } else {
...
<body>
    ...
    <form name="login" method="post" action="" >
        ...
        <div class="login-input-box">
            <input name="id" type="text" name="id" value="<?php echo $row['student_id']; ?>" readonly /></div>
