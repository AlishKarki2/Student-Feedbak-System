...
if (!$conn) {
    ...
    $sql = "SELECT MAX(teacher_id) AS max_id FROM teacher";
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO teacher (teacher_id, username, contact_number, fname, email, password,subject,admin_id)
            VALUES ('$teacher_id', '$username', '$contact_number','$fname', '$email', '$hash','$subject',1)";
...
<body>
    ...
    <form name="login" method="post" action="" >
        ...
        <div class="login-input-box">
            <input name="contact" type="text" placeholder="Enter your Contact Number" name="contact" pattern="[0-9]{10}"/>
        </div>
        ...
        <div class="login-input-box">
            <input name="subject" type="text" placeholder="Enter Subject" name="subject"/>
        </div>
