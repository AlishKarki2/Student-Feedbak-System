			...
			<tbody>
				<?php foreach($data as $d){ ?>
					<tr>
						...
						<td>
							<a href="fwdfeedback.php?id=<?php echo $d['feedback_id']?>">
								<button class="button-forward">Forward</button>
							</a>
							<a href="remarks.php?id=<?php echo $d['feedback_id']?>">
								<button class="button-delete">Reject</button>
							</a>
						</td>
					</tr>
				<?php } ?>
